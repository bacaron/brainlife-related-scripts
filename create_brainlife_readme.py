...
# app_title="app title"                                             
# app_description="do something" # Note: code already writes "This app will "                              
# Authors="Brad Caron (bacaron@iu.edu)\n Soichi Hayashi (hayashi@iu.edu)"                         
# Contributors="Franco Pestilli"                                        
# References="Insert reference citation here"                                                
# json_structure="{'t1': './testdata/t1.nii.gz'}"                                 
# dependencies="Singularity\n Json"                                        
# app_output="some data" # note: code already writes "The main output of this app is"
